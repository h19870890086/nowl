...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // 允许的域名（支持通过环境变量配置）
        configuration.addAllowedOriginPattern(allowedOriginPattern1);
        configuration.addAllowedOriginPattern(allowedOriginPattern2);
        // Spring的allowedOriginPattern对于不带端口的Origin不匹配带:*的通配模式
        configuration.addAllowedOriginPattern(allowedOriginPattern1.replaceAll(":\\*$", ""));
        configuration.addAllowedOriginPattern(allowedOriginPattern2.replaceAll(":\\*$", ""));
