        ...
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
              ...
              <button
                class="rounded-xl bg-emerald-50 border border-emerald-100 px-3 py-2 text-left hover:border-emerald-300 hover:bg-emerald-100/50 transition-colors min-h-[92px] flex flex-col justify-between"
              ...
              >
                ...
                <div class="text-[11px] text-emerald-500 mt-1">点击充值</div>
              </button>
              <button
